...
- Preview: https://main--cuddly-octo-giggle--kosmall.hlx.page/
- Live: https://main--cuddly-octo-giggle--kosmall.hlx.live/
...
1. Open the `cuddly-octo-giggle` directory in your favorite IDE and start coding :)
